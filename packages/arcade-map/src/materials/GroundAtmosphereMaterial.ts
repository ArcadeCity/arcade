...
export interface GroundAtmosphereMaterialParameters
    ...
    updateUniforms(
        ...
        if (shaderMaterial !== undefined && shaderMaterial.isMaterial) {
            if (
                ...
                shaderMaterial.uniforms.u_lightDirectionWorld.value =
            ...
            throw Error(
                'Wrong object used, only Material objects are supported'
            )
        }
    }
