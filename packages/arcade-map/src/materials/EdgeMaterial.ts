...
import {
    ExtrusionFeature, ExtrusionFeatureParameters, FadingFeature,
            ...
            shaderParams = {
                ...
                uniforms: {
                    color: new THREE.Uniform(
                        new THREE.Color(EdgeMaterial.DEFAULT_COLOR)
                    ),
                    edgeColor: new THREE.Uniform(
                        new THREE.Color(EdgeMaterial.DEFAULT_COLOR)
                    ),
                    edgeColorMix: new THREE.Uniform(
                    ...
                    extrusionRatio: new THREE.Uniform(
