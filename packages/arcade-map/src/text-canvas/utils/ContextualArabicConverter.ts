...
export class ContextualArabicConverter {
    ...
    private constructor() {
        // Single characters.
        this.m_singleCharactersMap.set(0x0621, [
            undefined,
            undefined,
            undefined,
        ]) // HAMZA
    ...
    convert(input: string): string {
        ...
        for (let i = 0; i < input.length; ++i) {
            ...
            if (this.isArabicCharacter(currentCodePoint)) {
                ...
                let prevCodePoint =
                    prevIndex >= 0 ? input.charCodeAt(prevIndex) : undefined
                ...
                if (
                    ...
                    if (prevCodePoint !== undefined) {
                        output += String.fromCharCode(
                            combinedMap[CombinedForm.Connected]!
                        )
                    } else {
                        output += String.fromCharCode(
                            combinedMap[CombinedForm.Isolated]!
                        )
                    }
                ...
                // Final.
                    ...
                    prevCodePoint !== undefined &&
                    map[ContextualForm.Final] !== undefined
                ) {
                ...
                // Initial.
                    ...
                    nextCodePoint !== undefined &&
                    map[ContextualForm.Initial] !== undefined
                ) {
