 ...
 */
export function hAlignFromPlacement(
    hP: HorizontalPlacement
): HorizontalAlignment {
 ...
 */
export function hPlacementFromAlignment(
 ...
 */
export function vPlacementFromAlignment(
...
export namespace DefaultTextStyle {
    ...
    export const DEFAULT_BACKGROUND_COLOR: THREE.Color = new THREE.Color(
        0x000000
    )
        ...
        this.m_params = {
            ...
            fontSize:
                params.fontSize !== undefined
                    ...
                    : {
                          ...
                          backgroundSize:
                              DefaultTextStyle.DEFAULT_FONT_SIZE.backgroundSize,
                      },
            fontStyle:
            ...
            rotation:
                params.rotation !== undefined
                    ? params.rotation
                    : DefaultTextStyle.DEFAULT_ROTATION,
            color:
            ...
            opacity:
                params.opacity !== undefined
                    ? params.opacity
                    : DefaultTextStyle.DEFAULT_OPACITY,
            backgroundColor:
        ...
        this.m_params = {
            tracking:
                params.tracking !== undefined
                    ? params.tracking
                    : DefaultTextStyle.DEFAULT_TRACKING,
            leading:
                params.leading !== undefined
                    ? params.leading
                    : DefaultTextStyle.DEFAULT_LEADING,
            maxLines:
