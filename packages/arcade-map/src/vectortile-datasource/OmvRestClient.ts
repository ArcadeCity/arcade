...
import '@arcadecity/arcade-map/fetch'
import { TileKey, TilingScheme } from '@arcadecity/arcade-map/geoutils'
import { DataProvider } from '@arcadecity/arcade-map/mapview-decoder'
import {
  ITransferManager, TransferManager
} from '@arcadecity/arcade-map/transfer-manager'
...
export interface OmvRestClientParameters {
   ...
   *  - `{z}` - zoom level of tile, @see {@link @arcadecity/arcade-map/geoutils#TileKey.level}
   *  - `{x}` - horizontal coordinate of tile (column number),
   *            see {@link @arcadecity/arcade-map/geoutils#TileKey.column}
   *  - `{y}` - vertical coordinate of Tile (row number),
   *            see {@link @arcadecity/arcade-map/geoutils#TileKey.row}
   *
