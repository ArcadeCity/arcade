 ...
 */
import {
    EarthConstants, isVector3Like, Vector2Like, Vector3Like,
...
export function tile2world<VectorType extends Vector3Like>(
    ...
    if (
        ...
        decodeInfo.worldTileProjectionCookie =
            createWorldTileTransformationCookie(extents, decodeInfo)
    }
...
export function webMercatorTile2TargetWorld(
    ...
    decodeInfo.targetProjection.reprojectPoint(
        webMercatorProjection,
        target,
        target
    )
