...
import {
    GeoBox, OrientedBox3, Projection, TileKey, TilingScheme,
...
export class DecodeInfo {
    ...
    constructor(
        ...
        this.columnCount =
            webMercatorTilingScheme.subdivisionScheme.getLevelDimensionX(
                this.tileKey.level
            )

        this.rowCount =
            webMercatorTilingScheme.subdivisionScheme.getLevelDimensionY(
                this.tileKey.level
            )
    }
