...
import {
  GeoJson, ITiler, WorkerServiceProtocol
} from '@arcadecity/arcade-map/datasource-protocol'
import { TileKey } from '@arcadecity/arcade-map/geoutils'
import { ConcurrentTilerFacade } from '@arcadecity/arcade-map/mapview'
...
/**
 * GeoJson {@link @arcadecity/arcade-map/mapview-decoder@DataProvider}.
 *
 * @remarks
