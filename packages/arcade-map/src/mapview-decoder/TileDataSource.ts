...
} from '@arcadecity/arcade-map/mapview'
import { ILogger, LoggerManager } from '@arcadecity/arcade-map/utils'
...
export class TileDataSource<TileType extends Tile = Tile> extends DataSource {
   ...
   *
   * Applies new {@arcadecity/arcade-map/datasource-protocol StyleSet} and definitions from theme only
