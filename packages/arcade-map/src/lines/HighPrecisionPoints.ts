...
import { HighPrecisionPointMaterial } from '@arca/materials'
 ...
 */
export class HighPrecisionPoints
    extends THREE.Points
    implements HighPrecisionObject
{
    ...
    constructor(
        ...
        super(
            geometry === undefined ? new THREE.BufferGeometry() : geometry,
            material
        )
    ...
    setupForRendering(): void {
        ...
        this.onBeforeRender = (
            ...
            HighPrecisionUtils.updateHpUniforms(
                this,
                camera,
                this.shaderMaterial
            )
