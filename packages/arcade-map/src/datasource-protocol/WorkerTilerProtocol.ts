...
export namespace WorkerTilerProtocol {
     ...
     */
    export interface RegisterIndexRequest
        extends WorkerServiceProtocol.ServiceRequest {
     ...
     */
    export function isRegisterIndexRequest(
        message: any
    ): message is RegisterIndexRequest {
        return (
            message &&
            typeof message.type === 'string' &&
            message.type === Requests.RegisterIndex
        )
    }
     ...
     */
    export function isUpdateIndexRequest(
        message: any
    ): message is UpdateIndexRequest {
        return (
            message &&
            typeof message.type === 'string' &&
            message.type === Requests.UpdateIndex
        )
    }
    ...
    export function isTileRequest(message: any): message is TileRequest {
        return (
            message &&
            typeof message.type === 'string' &&
            message.type === Requests.TileRequest
        )
    }
}
