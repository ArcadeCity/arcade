...
import {
    ...
    ExtrudedPolygonTechniqueParams, FillTechniqueParams, isTextureBuffer,
    LineTechniqueParams, MarkerTechniqueParams, PointTechniqueParams,
    ...
    TerrainTechniqueParams, TextTechniqueParams, TextureCoordinateType
...
type RemoveInterpolatedPropDef<T> =
    | T
    | InterpolatedPropertyDefinition<any> extends T
 ...
 */
export interface SquaresTechnique
    extends MakeTechniqueAttrs<PointTechniqueParams> {
    name: 'squares'
}
 ...
 * For technique parameters see `PointTechniqueParams`.
 */
export interface CirclesTechnique
    extends MakeTechniqueAttrs<PointTechniqueParams> {
    name: 'circles'
}
 ...
 */
export interface PoiTechnique
    extends MakeTechniqueAttrs<MarkerTechniqueParams> {
    name: 'labeled-icon'
}
 ...
 * For technique parameters see `MarkerTechniqueParams`.
 */
export interface LineMarkerTechnique
    extends MakeTechniqueAttrs<MarkerTechniqueParams> {
    name: 'line-marker'
}
 ...
 */
export interface SegmentsTechnique
    extends MakeTechniqueAttrs<SegmentsTechniqueParams> {
    name: 'segments'
}
 ...
 */
export interface SolidLineTechnique
    extends MakeTechniqueAttrs<SolidLineTechniqueParams> {
 ...
 */
export interface StandardTechnique
    extends MakeTechniqueAttrs<StandardTechniqueParams> {
    name: 'standard'
}
...
export interface ShaderTechnique
    extends MakeTechniqueAttrs<ShaderTechniqueParams> {
    name: 'shader'
}
 ...
 */
export interface TerrainTechnique
    extends MakeTechniqueAttrs<TerrainTechniqueParams> {
    name: 'terrain'
}
 ...
 */
export interface LabelRejectionLineTechnique
    extends MakeTechniqueAttrs<BaseTechniqueParams> {
 ...
 */
export function isTerrainTechnique(
    technique: Technique
): technique is TerrainTechnique {
 ...
 */
export function textureCoordinateType(
    technique: Technique
 ...
 */
export function addBuffersToTransferList(
    technique: Technique,
    ...
    if (
        ...
        const computeRenderOrder = (category: string): number | undefined => {
            const priority = priorities?.findIndex(
                (entry) =>
                    entry.group === technique._styleSet &&
