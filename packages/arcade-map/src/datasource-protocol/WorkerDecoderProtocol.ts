...
export namespace WorkerDecoderProtocol {
     ...
     */
    export function isDecodeTileRequest(
        message: any
    ): message is DecodeTileRequest {
        return (
            message &&
            typeof message.type === 'string' &&
     ...
     */
    export interface TileInfoRequest
        extends WorkerServiceProtocol.ServiceRequest {
     ...
     */
    export function isTileInfoRequest(
        message: any
    ): message is TileInfoRequest {
        return (
            message &&
            typeof message.type === 'string' &&
            message.type === Requests.TileInfoRequest
        )
    }
}
