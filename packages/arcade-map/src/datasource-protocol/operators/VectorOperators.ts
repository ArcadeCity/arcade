...
const operators = {
    'make-vector': {
        call: (context: ExprEvaluatorContext, call: MakeVectorCallExpr) => {
            ...
            const components = call.args.map((arg) =>
    ...
    vector2: {
        call: (context: ExprEvaluatorContext, call: CallExpr) =>
            isVector(context, call, 'vector2'),
    },
    vector3: {
        call: (context: ExprEvaluatorContext, call: CallExpr) =>
            isVector(context, call, 'vector3'),
    },
    vector4: {
        call: (context: ExprEvaluatorContext, call: CallExpr) =>
            isVector(context, call, 'vector4'),
    },
    'to-vector2': {
        call: (context: ExprEvaluatorContext, call: CallExpr) =>
            toVector(context, call, 'vector2'),
    },
    'to-vector3': {
        call: (context: ExprEvaluatorContext, call: CallExpr) =>
            toVector(context, call, 'vector3'),
    },
    'to-vector4': {
        call: (context: ExprEvaluatorContext, call: CallExpr) =>
            toVector(context, call, 'vector4'),
    },
}
