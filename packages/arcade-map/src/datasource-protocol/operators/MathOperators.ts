...
const operators = {
        ...
        call: (context: ExprEvaluatorContext, call: CallExpr) => {
            if (call.args.length === 1) {
                ...
                if (typeof value !== 'number') {
                    throw new Error(
                        `ìnvalid operand '${typeof value} for operator '-'`
                    )
                }
    ...
    '+': {
        call: (context: ExprEvaluatorContext, call: CallExpr) => {
            return call.args.reduce(
                (a, b) => Number(a) + Number(context.evaluate(b)),
                0
            )
        },
    },
    ...
    acos: {
        call: (context: ExprEvaluatorContext, call: CallExpr) => {
            ...
            if (typeof value !== 'number') {
                throw new Error(
                    `invalid operand '${value}' for operator 'acos'`
                )
            }
    ...
    asin: {
        call: (context: ExprEvaluatorContext, call: CallExpr) => {
            ...
            if (typeof value !== 'number') {
                throw new Error(
                    `invalid operand '${value}' for operator 'asin'`
                )
            }
    ...
    atan: {
        call: (context: ExprEvaluatorContext, call: CallExpr) => {
            ...
            if (typeof value !== 'number') {
                throw new Error(
                    `invalid operand '${value}' for operator 'atan'`
                )
            }
    ...
    ceil: {
        call: (context: ExprEvaluatorContext, call: CallExpr) => {
            ...
            if (typeof value !== 'number') {
                throw new Error(
                    `invalid operand '${value}' for operator 'ceil'`
                )
            }
    ...
    floor: {
        call: (context: ExprEvaluatorContext, call: CallExpr) => {
            ...
            if (typeof value !== 'number') {
                throw new Error(
                    `invalid operand '${value}' for operator 'floor'`
                )
            }
    ...
    log10: {
        call: (context: ExprEvaluatorContext, call: CallExpr) => {
            ...
            if (typeof value !== 'number') {
                throw new Error(
                    `invalid operand '${value}' for operator 'log10'`
                )
            }
    ...
    max: {
        call: (context: ExprEvaluatorContext, call: CallExpr) => {
            return Math.max(
                ...call.args.map((v) => Number(context.evaluate(v)))
            )
        },
    },
    ...
    clamp: {
        call: (context: ExprEvaluatorContext, call: CallExpr) => {
            ...
            if (
                ...
                throw new Error(
                    `invalid operands '${v}', ${min}, ${max} for operator 'clamp'`
                )
            }
    ...
    round: {
        call: (context: ExprEvaluatorContext, call: CallExpr) => {
            ...
            if (typeof value !== 'number') {
                throw new Error(
                    `invalid operand '${value}' for operator 'round'`
                )
            }
    ...
    sqrt: {
        call: (context: ExprEvaluatorContext, call: CallExpr) => {
            ...
            if (typeof value !== 'number') {
                throw new Error(
                    `invalid operand '${value}' for operator 'sqrt'`
                )
            }
