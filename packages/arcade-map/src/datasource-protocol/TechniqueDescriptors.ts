 ...
 */
import {
    BaseTechniqueParams, PointTechniqueParams, PolygonalTechniqueParams
} from './TechniqueParams'
import {
    CirclesTechnique, ExtrudedPolygonTechnique, FillTechnique, IndexedTechnique,
    LineMarkerTechnique, LineTechnique, ShaderTechnique, SolidLineTechnique,
    SquaresTechnique, StandardTechnique, Technique, TextTechnique
} from './Techniques'
 ...
 *
 */
type TechniquePropNames<T> = T extends { name: any }
    ? keyof Omit<T, 'name'>
    : keyof T
...
type TechniqueByName<K extends Technique['name']> = OneThatMatches<
    Technique,
    { name: K }
>
...
const baseTechniqueParamsDescriptor: TechniqueDescriptor<BaseTechniqueParams> =
    {
        ...
        attrDescriptors: {
            ...
            transparent: {
                scope: AttrScope.TechniqueRendering,
                automatic: true,
            },
...
const lineMarkerTechniquePropTypes =
    mergeTechniqueDescriptor<LineMarkerTechnique>(
        baseTechniqueParamsDescriptor,
        {
            attrDescriptors: {
...
const solidLineTechniqueDescriptor =
    mergeTechniqueDescriptor<SolidLineTechnique>(
        baseTechniqueParamsDescriptor,
...
const extrudedPolygonTechniqueDescriptor =
    mergeTechniqueDescriptor<ExtrudedPolygonTechnique>(
        baseTechniqueParamsDescriptor,
