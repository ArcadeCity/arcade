...
export class DisplacedBufferGeometry extends THREE.BufferGeometry {
    ...
    reset(
        ...
        this.m_displacedPositions.reset(
            positions,
            normals,
            uvs,
            displacementMap
    ...
    computeBoundingBox(): void {
        ...
        const origBBox = this.m_originalBoundingBox.copy(
        ...
        displaceBox(
            ...
            tmpV1.fromBufferAttribute(
                this.attributes.normal as THREE.BufferAttribute,
                0
            )
        )
    }
    ...
    private needsBoundingBoxUpdate(displacementRangeChanged: boolean): boolean {
        return (
            ...
            (this.boundingBox !== null &&
                (!this.originalGeometry.boundingBox ||
                    !this.m_originalBoundingBox.equals(
                        this.originalGeometry.boundingBox
                    )))
        )
    }
