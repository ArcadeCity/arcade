...
import { Vector3Like } from '@arca/geoutils'
import { sampleBilinear } from '@arca/utils'
...
export class DisplacedBufferAttribute extends THREE.BufferAttribute {
    ...
    private readonly m_cache = new VertexCache(
        DisplacedBufferAttribute.MAX_CACHE_SIZE
    )
    ...
    constructor(
        ...
        super(
            originalAttribute.array,
            originalAttribute.itemSize,
            originalAttribute.normalized
        )
