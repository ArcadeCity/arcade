...
export class TileGeometryManager {
    ...
    enableKind(
        ...
        this.enableDisableKinds(
            this.enabledKinds,
            kind,
            addOrRemoveToEnabledSet
        )
    }
    ...
    hideKind(
        ...
        if (Array.isArray(kind) || kind instanceof Set) {
            ...
            visibilityHasChanged = this.addRemove(
                this.hiddenKinds,
                kind,
                addOrRemoveToHiddenSet
            )
        ...
        for (const tile of tiles) {
            ...
            for (const object of tile.objects) {
                ...
                if (geometryKind !== undefined) {
                    const nowVisible = !geometryKind.some((kind) =>
