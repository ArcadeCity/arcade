...
import { GradientSky } from '@arcadecity/arcade-map/datasource-protocol'
import { ProjectionType } from '@arcadecity/arcade-map/geoutils'
import { getOptionValue } from '@arcadecity/arcade-map/utils'
