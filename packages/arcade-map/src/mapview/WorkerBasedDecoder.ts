 ...
 */
import {
    DecodedTile, DecoderOptions, getProjectionName, ITileDecoder, OptionsMap,
    RequestController, TileInfo, WorkerDecoderProtocol, WorkerServiceProtocol
...
export class WorkerBasedDecoder implements ITileDecoder {
     ...
     *
     * @remarks
     * Invokes {@link @arca/datasource-protocol#DecodeTileRequest} on
    ...
    /**
     * Get {@link @arca/datasource-protocol#TileInfo} from tile decoder service in worker.
     *
     * @remarks
     * Invokes {@link @arca/datasource-protocol#TileInfoRequest}
     ...
     *
     * @remarks
     * Broadcasts {@link @arca/datasource-protocol#ConfigurationMessage}
