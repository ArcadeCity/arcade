...
import {
    GeometryKind, GeometryKindSet, ImageTexture, LineMarkerTechnique,
    PoiStackMode, PoiTechnique
} from '@arca/datasource-protocol'
import {
    GlyphData, TextBufferObject, TextLayoutParameters, TextLayoutStyle,
    TextRenderParameters, TextRenderStyle
...
export interface PoiInfo {
    ...
    /**
     * Name of the {@link @arca/datasource-protocol#ImageTexture} or image in
     * {@link @arca/mapview#userImageCache}.
     */
     ...
     * Icon color override
     *
     * @see {@link @arca/datasource-protocol#MarkerTechniqueParams.iconColor};
     */
     ...
     * Icon brightness.
     *
     * @see {@link @arca/datasource-protocol#MarkerTechniqueParams.iconBrightness};
     */
    ...
    /**
     * @hidden
     * Direct access to {@link @arca/datasource-protocol#ImageTexture} once it is resolved.
     */
...
export class TextElement {
    ...
    /**
     * @hidden
     * Array storing the style {@link @arca/text-canvas#GlyphData} for
    ...
    constructor(
        ...
        this.type =
            points instanceof THREE.Vector3
    ...
    set poiInfo(poiInfo: PoiInfo | undefined) {
        ...
        if (poiInfo !== undefined) {
            ...
            const poiRenderOrder =
                this.renderOrder !== undefined ? this.renderOrder : 0
