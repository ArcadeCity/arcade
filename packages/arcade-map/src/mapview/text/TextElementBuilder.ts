...
import { assert, LoggerManager, MathUtils } from '@arcadecity/arcade-map/utils'
...
/**
 * Constructs {@link TextElement} objects from {@link @arcadecity/arcade-map/datasource-protocol/Technique},
...
export class TextElementBuilder {
   ...
   * Constructor
   *
   * @param m_env - The {@link @link @arcadecity/arcade-map/datasource-protocol#MapEnv} used to evaluate
   * technique properties.
   * @param m_styleCache - To cache instances of {@link @arcadecity/arcade-map/text-canvas/TextRenderStyle}
   * and {@link @arcadecity/arcade-map/text-canvas/TextLayoutStyle}.
   */
  constructor(
   ...
   *
   * @param technique - The {@link @arcadecity/arcade-map/datasource-protocol/Technique}.
   * @return This builder.
   */
  withTechnique(
