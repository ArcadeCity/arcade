...
import {
    hAlignFromPlacement, hPlacementFromAlignment, TextPlacement,
    vAlignFromPlacement, vPlacementFromAlignment
...
export class TextElementState {
    ...
    get initialized(): boolean {
        return (
            ...
            this.m_iconRenderState !== undefined
        )
    }
    ...
    get visible(): boolean {
        if (
            this.m_textRenderState !== undefined &&
            this.m_textRenderState.isVisible()
        ) {
            return true
        }
    ...
    get textPlacement(): TextPlacement {
        ...
        const lastPlacement =
            stateLayout !== undefined
                ...
                : {
                      h: hPlacementFromAlignment(
                          themeLayout.horizontalAlignment
                      ),
    ...
    set textPlacement(placement: TextPlacement) {
        if (
            ...
            this.isBaseTextPlacement(placement) === true
        ) {
    ...
    isBaseTextPlacement(placement: TextPlacement): boolean | undefined {
        ...
        if (themeLayout !== undefined) {
            return (
                hAlignFromPlacement(placement.h) ===
                    themeLayout.horizontalAlignment &&
                vAlignFromPlacement(placement.v) ===
                    themeLayout.verticalAlignment
            )
        }
        return undefined
    }
    ...
    public get position(): THREE.Vector3 {
        return this.element.path !== undefined &&
            this.m_lineMarkerIndex !== undefined
    ...
    private initializeRenderStates() {
        ...
        if (
            ...
            // in sync.
            const techniqueIconFadeTime =
                this.element.poiInfo?.technique.iconFadeTime
            const iconFadeTime =
                techniqueIconFadeTime !== undefined
                    ? techniqueIconFadeTime * 1000
                    : textFadeTime
