...
import { TileKey, TilingScheme, webMercatorTilingScheme } from '@arca/geoutils'
...
export class BackgroundDataSource extends DataSource {
    ...
    private m_tilingScheme: TilingScheme =
        BackgroundDataSource.DEFAULT_TILING_SCHEME
    ...
    setTilingScheme(tilingScheme?: TilingScheme) {
        const newScheme =
            tilingScheme ?? BackgroundDataSource.DEFAULT_TILING_SCHEME
