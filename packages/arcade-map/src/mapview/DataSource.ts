...
import { ExprPool, Theme, ValueMap } from '@arca/datasource-protocol'
import { Projection, TileKey, TilingScheme } from '@arca/geoutils'
...
export abstract class DataSource extends THREE.EventDispatcher {
    ...
    /**
     * The {@link @arca/geoutils#Projection} used by
     * the {@link MapView} that is holding this `DataSource`.
     *
    ...
    /**
     * Returns the {@link @arca/geoutils#TilingScheme} used by this `DataSource`.
     */
    ...
    /**
     * Apply the {@link @arca/datasource-protocol#Theme} to this data source.
     *
    ...
    isVisible(zoomLevel: number): boolean {
        return (
            zoomLevel >= this.minDisplayLevel &&
            zoomLevel <= this.maxDisplayLevel
        )
    }

    /**
     * Returns `true` if {@link DataSource} can load tile with
     * given {@link @arca/geoutils#TileKey} and zoom level.
     *
     * @param zoomLevel - The zoom level of the {@link MapView}.
     * @param tileKey - The unique identifier for a map tile.
     * @returns `true` if the tile for the given {@link @arca/geoutils#TileKey} can be loaded.
     */
     ...
     * further with given {@link @arca/geoutils#TileKey} and
     * zoom level.
     *
     * @param zoomLevel - The zoom level of the {@link MapView}.
     * @param tileKey - The unique identifier for a map tile.
     * @returns `true` if the subtiles of the given {@link @arca/geoutils#TileKey} should be
     ...
     * elements with the given {@link @arca/geoutils#TileKey} and
     * zoom level.
     *
     * @remarks
     ...
     *          given {@link @arca/geoutils#TileKey} should be rendered.
     */
