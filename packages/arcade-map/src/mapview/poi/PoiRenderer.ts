 ...
 */
import {
  Env, getPropertyValue, ImageTexture
} from '@arcadecity/arcade-map/datasource-protocol'
import { IconMaterial } from '@arcadecity/arcade-map/materials'
import { MemoryUsage } from '@arcadecity/arcade-map/text-canvas'
import { assert, LoggerManager, Math2D } from '@arcadecity/arcade-map/utils'
 ...
 * ({@link @arcadecity/arcade-map/datasource-protocol#ImageTexture}).
 *
