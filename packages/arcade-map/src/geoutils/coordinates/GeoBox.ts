...
export class GeoBox implements GeoBoxExtentLike {
    ...
    growToContain(point: GeoCoordinatesLike) {
        this.southWest.latitude = Math.min(
            this.southWest.latitude,
            point.latitude
        )
        this.southWest.longitude = Math.min(
        ...
        this.northEast.latitude = Math.max(
            this.northEast.latitude,
            point.latitude
        )
        this.northEast.longitude = Math.max(
