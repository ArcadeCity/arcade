...
export const Demo = () => {
  ...
  const colors = useMemo(() => indices.map((i) => palette[i % palette.length]), [indices])

  const oslo = useImage(require('../oslo.jpg'))
  ...
  return (
    <Canvas style={{ width, height }}>
      <Vertices vertices={vertices} indices={indices} textures={defaultVertices} colors={colors} />
