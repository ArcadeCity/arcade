...
import {
  RootStackParamList, RootStackScreenProps, RootTabScreenProps
...
export const RequestBegin = observer(
  ({ navigation, route }: RootStackScreenProps<'RequestBegin'>) => {
    const { authStore, modalStore, serviceStore } = useStores()
    const service: 'ride' | 'delivery' | 'other' = route.params.serviceType
